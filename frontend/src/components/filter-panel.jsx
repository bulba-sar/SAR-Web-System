        ...
        <div className="space-y-2 lg:space-y-3">
          ...
          <div className="relative">
              <input
                ...
                className="w-full border border-zinc-200 dark:border-zinc-600 rounded-lg pl-9 pr-3 py-2 text-[10px] lg:text-xs focus:outline-none focus:ring-2 focus:ring-[#3f7b56]/30 focus:border-[#3f7b56] font-normal text-zinc-500 dark:text-zinc-300 bg-white dark:bg-zinc-800"
              />
