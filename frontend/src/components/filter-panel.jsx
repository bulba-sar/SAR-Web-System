    ...
    <div className="w-72 lg:w-80 h-screen bg-white dark:bg-zinc-900 border-r border-zinc-200 dark:border-zinc-700 flex flex-col shadow-xl z-10 transition-all">
      ...
      <div className="p-3 lg:p-4 border-b border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-800 flex items-center justify-between gap-3">
        <div className="flex flex-col leading-tight">
          ...
          <p className="text-[9px] lg:text-[10px] font-medium tracking-wide text-[#23432f] dark:text-[#a0d870]" style={{ fontFamily: 'Georgia, serif' }}>
      ...
      <div className="flex-1 overflow-y-auto sar-scrollbar p-4 lg:p-6 space-y-5 lg:space-y-8 bg-white dark:bg-zinc-900">
        ...
        <div className="space-y-2 lg:space-y-3">
          ...
          <div className="relative">
              <input
                ...
                className="w-full border border-zinc-200 dark:border-zinc-600 rounded-lg pl-9 pr-3 py-2 text-[10px] lg:text-xs focus:outline-none focus:ring-2 focus:ring-[#3f7b56]/30 focus:border-[#3f7b56] font-normal text-zinc-900 dark:text-zinc-100 bg-white dark:bg-zinc-800 placeholder:text-zinc-400 dark:placeholder:text-zinc-500"
              />
        ...
        <div className="space-y-3 lg:space-y-4"> 
          ...
          <div className="space-y-1.5 lg:space-y-2"> 
            ...
            <input 
              ...
              className="w-full h-1.5 lg:h-2 bg-zinc-200 dark:bg-zinc-600 rounded-lg appearance-none cursor-pointer accent-green-500"
            />
          </div>
        </div>
            ...
            {can('protected_areas') && (
              <label className="flex items-center justify-between cursor-pointer group">
                ...
                <div className="relative">
                  ...
                  />
                  <div className={`block w-9 h-5 lg:w-10 lg:h-6 rounded-full transition-colors ${showProtected ? 'bg-green-500' : 'bg-zinc-200 dark:bg-zinc-600'}`}></div>
                  <div className={`absolute left-0.5 top-0.5 lg:left-1 lg:top-1 bg-white dark:bg-zinc-300 w-4 h-4 rounded-full transition-transform ${showProtected ? 'translate-x-4' : ''}`}></div>
                </div>
              </label>
            )}
            ...
            {can('crop_suitability') && (
              <label className="flex items-center justify-between cursor-pointer group">
                ...
                <div className="relative">
                  ...
                  />
                  <div className={`block w-9 h-5 lg:w-10 lg:h-6 rounded-full transition-colors ${showCropSuitability ? 'bg-green-500' : 'bg-zinc-200 dark:bg-zinc-600'}`}></div>
                  <div className={`absolute left-0.5 top-0.5 lg:left-1 lg:top-1 bg-white dark:bg-zinc-300 w-4 h-4 rounded-full transition-transform ${showCropSuitability ? 'translate-x-4' : ''}`}></div>
                </div>
              </label>
            )}
